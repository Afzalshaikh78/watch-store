...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    ...
    <div onMouseEnter={() => setProductHover(product.id, true)}
  onMouseLeave={() => setProductHover(product.id, false)}  className="relative w-[20rem] m-[1rem] border-white ml-[3rem] p-4">
    <div className="relative bg-gray-200 p-4">
      <img src={currentImage} alt={product.title} className="object-contain w-[12rem] h-[12rem] rounded-md ml-[1rem]" />
